...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webApp.Models.EntryLevelCourse", b =>
                {
                    b.Property<string>("CourseCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("StudyPlanEntryLevelId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CourseCode", "StudyPlanEntryLevelId");

                    b.HasIndex("StudyPlanEntryLevelId");

                    b.ToTable("EntryLevelCourses");
                });
            ...
            modelBuilder.Entity("webApp.Models.ProgramLevelCourse", b =>
                {
                    b.Property<string>("CourseCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("StudyPlanProgramLevelId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CourseCode", "StudyPlanProgramLevelId");

                    b.HasIndex("StudyPlanProgramLevelId");

                    b.ToTable("ProgramLevelCourses");
                });
            ...
            modelBuilder.Entity("webApp.Models.StudyPlanEntryLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudyPlanEntryLevels");
                });

            modelBuilder.Entity("webApp.Models.StudyPlanProgramLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudyPlanProgramLevels");
                });
            ...
            modelBuilder.Entity("webApp.Models.EntryLevelCourse", b =>
                {
                    ...
                    b.HasOne("webApp.Models.StudyPlanEntryLevel", "StudyPlanEntryLevel")
                        .WithMany("EntryLevelCourses")
                        .HasForeignKey("StudyPlanEntryLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Course");

                    b.Navigation("StudyPlanEntryLevel");
                });
            ...
            modelBuilder.Entity("webApp.Models.ProgramLevelCourse", b =>
                {
                    ...
                    b.HasOne("webApp.Models.StudyPlanProgramLevel", "StudyPlanProgramLevel")
                        .WithMany("ProgramLevelCourses")
                        .HasForeignKey("StudyPlanProgramLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Course");

                    b.Navigation("StudyPlanProgramLevel");
                });
            ...
            modelBuilder.Entity("webApp.Models.StudyPlanEntryLevel", b =>
                {
                    b.Navigation("EntryLevelCourses");
                });

            modelBuilder.Entity("webApp.Models.StudyPlanProgramLevel", b =>
                {
                    b.Navigation("ProgramLevelCourses");
                });
